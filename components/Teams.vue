    ...
    <section class="mt-16">
        <div class="md:flex md:items-center md:w-10/12 xl:w-8/12 md:m-auto">
            <div>
                ...
                <p class="pr-20 mt-3 text-whitegray text-sm">Lorem ipsum dolor sit amet, consecteur adipiscing elit.</p>
            </div>
            <div class="flex items-center">
                <div class="pr-2">
                    <img class="rounded-3xl" src="../assets/images/profiles/person3.png" alt="">
                </div>
                <div class="grid gap-2 grid-rows-2">
                    <img class="w-11/12 mt-auto rounded-3xl" src="../assets/images/profiles/person1.png" alt="">
